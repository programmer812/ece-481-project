...
plt.plot(TIME_STEPS_VEC, [x[0][0] for x in x_hat_plot], marker = 'x', ms = 0.5, label='x_hat1_x')
plt.grid()
plt.legend()
plt.xlabel('Time (s)')
plt.ylabel('State')
...
plt.plot(TIME_STEPS_VEC, [x[1][0] for x in x_hat_plot], marker = 'x', ms = 0.5, label='x_hat2_x')
plt.grid()
plt.legend()
plt.xlabel('Time (s)')
plt.ylabel('State')
...
plt.plot(TIME_STEPS_VEC, [x[2][0] for x in x_hat_plot], marker = 'x', ms = 0.5, label='x_hat3_x')
plt.grid()
plt.legend()
plt.xlabel('Time (s)')
plt.ylabel('State')
